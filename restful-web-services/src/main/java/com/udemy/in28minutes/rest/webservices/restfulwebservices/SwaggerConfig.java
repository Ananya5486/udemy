...
public class SwaggerConfig {
	public static final Contact DEFAULT_CONTACT = new Contact("Ananya", "6361946913", "udemy");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Rest Api Title", "Rest api Documentation", "1.0",
